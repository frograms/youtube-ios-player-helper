Pod::Spec.new do |s|
  s.name              = "youtube-ios-player-helper-test"
  s.version           = "1.0.5"
  ...
  s.source             = { :git => "git@github.com:frograms/youtube-ios-player-helper.git", :tag => "1.0.5" }

  s.platform     = :ios, '10.0'
  s.requires_arc = true

  s.source_files = 'Classes'
  s.resources = "youtube-ios-player-helper-test/Assets.bundle"
